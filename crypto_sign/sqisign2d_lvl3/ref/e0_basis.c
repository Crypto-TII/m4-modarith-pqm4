...
{0xa5c6, 0xdbd9, 0xa31a, 0x31c4, 0xd7b2, 0x1d65, 0x90c5, 0xe7ad, 0x6d61, 0x1e7, 0x217, 0x88ba, 0xddd, 0xa2e9, 0xcdb2, 0x2cb3, 0xf585, 0x2d06, 0x7007, 0xdc1b, 0x4ad1, 0x9489, 0xcbda, 0x16ee}
#else
...
#elif RADIX == 32
#if defined(SQISIGN_GF_REPR_SAT)
{0xdbd9a5c6, 0x31c4a31a, 0x1d65d7b2, 0xe7ad90c5, 0x1e76d61, 0x88ba0217, 0xa2e90ddd, 0x2cb3cdb2, 0x2d06f585, 0xdc1b7007, 0x94894ad1, 0x16eecbda}
#else
...
#elif RADIX == 16
#if defined(SQISIGN_GF_REPR_SAT)
{0x662a, 0x1ef8, 0x9616, 0xf420, 0x142d, 0x200d, 0xe8ce, 0xcba5, 0x7d81, 0xd10, 0xc5d4, 0x2205, 0xa7e7, 0xcc07, 0x30ec, 0xd003, 0xc3fa, 0xf934, 0xd4ad, 0x16d8, 0x3164, 0xb328, 0x5815, 0x606}
#else
...
#elif RADIX == 32
#if defined(SQISIGN_GF_REPR_SAT)
{0x1ef8662a, 0xf4209616, 0x200d142d, 0xcba5e8ce, 0xd107d81, 0x2205c5d4, 0xcc07a7e7, 0xd00330ec, 0xf934c3fa, 0x16d8d4ad, 0xb3283164, 0x6065815}
#else
...
#elif RADIX == 16
#if defined(SQISIGN_GF_REPR_SAT)
{0xc5b, 0x27a4, 0x99f7, 0x6f9, 0xf1da, 0xcebb, 0xca71, 0x50a8, 0x5c42, 0xb6e8, 0x12a7, 0x65cc, 0x774b, 0x13f8, 0xa12f, 0x9151, 0x9967, 0x4749, 0xd0d6, 0x8678, 0xff28, 0xdd51, 0xbfb6, 0x2e23}
#else
...
#elif RADIX == 32
#if defined(SQISIGN_GF_REPR_SAT)
{0x27a40c5b, 0x6f999f7, 0xcebbf1da, 0x50a8ca71, 0xb6e85c42, 0x65cc12a7, 0x13f8774b, 0x9151a12f, 0x47499967, 0x8678d0d6, 0xdd51ff28, 0x2e23bfb6}
#else
...
#elif RADIX == 16
#if defined(SQISIGN_GF_REPR_SAT)
{0x1c62, 0x588c, 0xee41, 0x6bcf, 0x4dfe, 0xcd64, 0x9a07, 0xa924, 0x5ff8, 0xd60b, 0xe097, 0xef21, 0xe310, 0xb509, 0xbfea, 0xceca, 0xd4bd, 0xce26, 0xf836, 0xf010, 0x3bb9, 0x6e85, 0x8755, 0x2a77}
#else
...
#elif RADIX == 32
#if defined(SQISIGN_GF_REPR_SAT)
{0x588c1c62, 0x6bcfee41, 0xcd644dfe, 0xa9249a07, 0xd60b5ff8, 0xef21e097, 0xb509e310, 0xcecabfea, 0xce26d4bd, 0xf010f836, 0x6e853bb9, 0x2a778755}
#else
